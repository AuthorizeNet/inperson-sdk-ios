...
The snippet of code will be used for the manual input for creating a Transaction.
...
- (void) createTransaction {
    ...
    creditCardType.expirationDate = @"1219";
...
This snippet of code is used to access the card swipe feature using approved Swipe Devices.

-(void) createSwipeTransaction{
